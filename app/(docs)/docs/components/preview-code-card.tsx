...
const PreviewCodeCard = async ({
  ...
  return (
    <CodeCard code={demoCode} className={cn("mb-14 mt-5", className)}>
      <div className="absolute hidden sm:block sm:top-10 sm:left-10 md:top-[100px] md:left-[600px] w-96 h-96 bg-purple-400/20 dark:bg-purple-600/10 rounded-full blur-3xl" />
