...
export default function AccordionPreview() {
  const accordionItems = [
    ...
    },
    {
      ...
      content: "Click on any heading to expand or collapse the content. Only one section is open at a time."
    },
    {
      title: "Why use an Accordion?",
      content: "Accordions are used to reduce page clutter and organize content efficiently."
    }
  ];
